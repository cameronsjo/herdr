...
Backfilled 2026-09-18. This divergence landed 2026-09-11 and was never given a ledger
section, which is how the 2026-09-17 sync met it as an unexplained test collision.
...
- **Regression check:** `cargo nextest run --locked -E 'test(/client::shell::tests::agents_worktrees_notifications::/)'`, plus `just bench-render-scale` for the sidebar grouping rework — measured flat at 1, 15 and 50 workspaces (1.00x / 0.92x / 1.19x median client-shell composition).
