...
fn status_commands_report_client_and_server_versions() {
    ...
    assert!(
        full_stdout.contains("  protocol: 1220"),
        "stdout: {full_stdout}"
    );
    ...
    assert!(
        server_stdout.contains("private_protocol: 1220"),
        "stdout: {server_stdout}"
    );
    ...
    assert!(
        client_stdout.contains("protocol: 1220"),
        "stdout: {client_stdout}"
    );
    assert!(
    ...
    assert_eq!(full_json["client"]["protocol"], 1220);
    ...
    assert_eq!(server_json["protocol"], 1220);
    ...
    assert_eq!(client_json["protocol"], 1220);
