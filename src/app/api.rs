...
impl App {
    ...
    pub(crate) fn handle_api_request_after_internal_events_drained(
        ...
        let response = match request.method {
            ...
            Method::WorkspaceMerge(params) => {
                return self.handle_workspace_merge(request.id, params);
            }
            ...
            Method::AgentTypeSubmit(params) => {
                return self.handle_agent_type_submit(request.id, params);
            }
