...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceOpen(_) => "workspace.open",
        ...
        Method::WorkspaceMerge(_) => "workspace.merge",
        ...
        Method::TabMoveToDestination(_) => "tab.move_to_destination",
        ...
        Method::AgentTypeSubmit(_) => "agent.type_submit",
