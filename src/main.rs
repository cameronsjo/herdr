...
# move_workspace_previous = "" # optional, e.g. "prefix+shift+comma" moves the workspace toward the front
# move_workspace_next = ""     # optional, e.g. "prefix+shift+period" moves the workspace toward the back
# move_pane_to_space = ""      # optional, unset by default; opens the destination picker
# move_pane_to_new_space = ""  # optional, unset by default
...
# swap_pane_left = ""     # optional, e.g. "prefix+shift+h" swaps with the pane to the left
# swap_pane_down = ""     # optional, e.g. "prefix+shift+j"
# swap_pane_up = ""       # optional, e.g. "prefix+shift+k"
# swap_pane_right = ""    # optional, e.g. "prefix+shift+l"
