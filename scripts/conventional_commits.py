...
def git_subjects(rev_range: str) -> list[str]:
    # --no-merges: a merge commit's subject ("Merge pull request #2 from ...")
    # is generated by GitHub and is not a change description, so it has nothing
    # to contribute to the preview notes this gate protects. Validating it only
    # forces squash merges, which this fork does not use.
